        ...
        <div className='row g-2 g-lg-5'>
          <div id='ContentBody_fullpage' className='col-lg-8'>
            ...
            <div id='ContentBody_post_body' className='news-body mb-4 text-justify'>
              ...
              />
              <p>
                <img alt='BaoCaoTaiChinh1' src={DichVuKeToanThueTronGoi} style={{ width: '100%' }} />
              </p>
              ...
              <h3 className='sub-title' id='Chi-phi-dich-vu-lam-bao-cao-tai-chinh'>
                ...
                <tbody>
                  <tr>
                    <td colSpan={3}>
                      <p style={{ textAlign: 'center' }}>
                        <span style={{ color: '#ffffff' }}>
                          <strong>Nhóm ngành Thi công xây dựng - Trang trí nội thất</strong>
                        </span>
                      </p>
                      <p style={{ textAlign: 'center' }}>
                        <span style={{ color: '#ffffff' }}>
                          <strong>Sản xuất - Gia công - Nhà hàng - Lắp đặt</strong>
                        </span>
                      </p>
                    </td>
                  </tr>
              ...
              <p>
                <strong>
                  <img className='lazy' src={LapBaoCaoTaiChinh1} style={{ width: '100%' }} />
                </strong>
              </p>
              <p style={{ textAlign: 'justify' }}>
                <u>Lưu ý:</u> Nếu doanh nghiệp vừa thành lập tại năm báo cáo thì không cần cung cấp bảng cân đối tài
                khoản năm trước báo cáo.
              </p>
              <h3 className='sub-title' id='Thoi-han-nop-bao-cao-tai-chinh-nam-2023 va-cac-quy-dinh-xu-phat'>
                <a id='buoc3'>Thời hạn nộp báo cáo tài chính năm 2023&nbsp;và các quy định xử phạt</a>
              </h3>
              <p style={{ textAlign: 'justify' }}>
                <strong>1. Thời gian nộp báo cáo tài chính năm 2023:&nbsp;</strong>
              </p>
              <p className='py-2' style={{ textAlign: 'justify' }}>
                Báo cáo tài chính của năm trước phải được nộp chậm nhất vào ngày thứ 90, kể từ ngày kết thúc năm dương
              ...
              <p className='py-2' style={{ textAlign: 'justify' }}>
                Theo Nghị định 41/2018/NĐ-CP về việc xử phạt vi phạm hành chính trong việc nộp trễ, nộp sai báo cáo tài
                chính như sau:
              </p>
              <table className='table-post-custom' style={{ width: '100%' }}>
                <tbody>
                  ...
                  <tr>
                    <td style={{ backgroundColor: '#ffe7d4' }}>
                      <p>Chậm nộp, chậm công khai BCTC dưới 3 tháng so với thời hạn quy định</p>
                    </td>
                    <td rowSpan={3} style={{ backgroundColor: '#ffe7d4' }}>
                      <p style={{ textAlign: 'left' }}>5.000.000đ - 10.000.000đ</p>
                    </td>
                  </tr>
                  <tr>
                    <td>
                  ...
                  <tr>
                    <td>
                      <p>Hạch toán không đúng theo quy định tài khoản kế toán</p>
                    </td>
                  </tr>
                  <tr>
                    <td>
                      <p>Chậm nộp, chậm công khai BCTC từ 3 tháng trở lên so với thời hạn quy định</p>
                    </td>
                    <td rowSpan={2}>
                      <p style={{ textAlign: 'left' }}>10.000.000đ - 20.000.000đ</p>
                    </td>
                  </tr>
                  <tr>
                    <td>
                      <p>
                        Không đính kèm báo cáo kiểm toán khi nộp BCTC và khi công khai BCTC (đối với các trường hợp đã
                        được quy định)
                      </p>
                    </td>
                  </tr>
                  <tr>
                    <td>
                      <p>Số liệu công khai BCTC không đúng với số liệu kế toán, chứng từ kế toán</p>
                    </td>
                    <td rowSpan={2} style={{ backgroundColor: '#ffe7d4' }}>
                      <p style={{ textAlign: 'left' }}>20.000.000đ - 30.000.000đ</p>
                    </td>
                  </tr>
                  <tr>
                    <td>
                      <p>
                        Các trường hợp thỏa thuận/ép buộc cung cấp thông tin, số liệu kế toán sai lệch thực tế hoặc giả
                        mạo BCTC
                      </p>
                    </td>
                  </tr>
              ...
              <ol>
                <li className='my-2' aria-level={1}>
                  <p style={{ textAlign: 'justify' }}>1. Thu thập các hóa đơn, chứng từ, sổ sách của doanh nghiệp;</p>
                </li>
                <li className='my-2' aria-level={1}>
                  <p style={{ textAlign: 'justify' }}>
                ...
                <li className='my-2' aria-level={1}>
                  <p style={{ textAlign: 'justify' }}>5. Loại bỏ và điều chỉnh các chứng từ không phù hợp;</p>
                </li>
                <li className='my-2' aria-level={1}>
                  <p style={{ textAlign: 'justify' }}>
                ...
                <li className='my-2' aria-level={1}>
                  <p style={{ textAlign: 'justify' }}>7. Kiểm tra chi phí lương, BHYT, BHXH…;</p>
                </li>
                <li className='my-2' aria-level={1}>
                  <p style={{ textAlign: 'justify' }}>8. Tính và lập các bảng khấu hao TSCĐ;</p>
                </li>
                <li className='my-2' aria-level={1}>
                  <p style={{ textAlign: 'justify' }}>9. Hạch toán kế toán trên phần mềm kế toán chuyên nghiệp;</p>
                </li>
                <li className='my-2' aria-level={1}>
                  <p style={{ textAlign: 'justify' }}>
                ...
                <li className='my-2' aria-level={1}>
                  <p style={{ textAlign: 'justify' }}>13. In báo cáo tài chính, sổ sách kế toán theo quy định.</p>
                </li>
              </ol>
              <p style={{ textAlign: 'justify' }}>
              ...
              <div id='faq'>
                ...
                <blockquote className='pl-3 mt-3 border-[#e5451b] border-l-[2px] '>
                  <p style={{ textAlign: 'justify' }}>
                    Báo cáo tài chính cuối năm gồm bảng cân đối kế toán, báo cáo kết quả hoạt động sản xuất kinh doanh,
                    lưu chuyển tiền tệ, bảng cân đối tài khoản và thuyết minh BCTC.
                  </p>
                </blockquote>
                <hr />
                <p style={{ textAlign: 'justify' }}>
                ...
                <blockquote className='pl-3 mt-3 border-[#e5451b] border-l-[2px] '>
                  <p style={{ textAlign: 'justify' }}>
                    Để tránh bị xử phạt chậm nộp báo cáo tài chính, mức phạt lên đến 20.000.000đ, bạn cần lưu ý thời hạn
                    nộp báo cáo tài chính, chậm nhất là ngày thứ 90 kể từ ngày kết thúc năm tài chính/năm dương lịch.
                  </p>
                </blockquote>
                <hr />
                <p style={{ textAlign: 'justify' }}>
                ...
                <blockquote className='pl-3 mt-3 border-[#e5451b] border-l-[2px] '>
                  ...
                  <p style={{ textAlign: 'justify' }}>
                    ...
                    <a href='http://localhost:3000/bao-cao-tai-chinh#buoc1'>Chi phí dịch vụ làm báo cáo tài chính</a>.
                  </p>
                </blockquote>
                <hr />
                <p style={{ textAlign: 'justify' }}>
                ...
                <blockquote className='pl-3 mt-3 border-[#e5451b] border-l-[2px] '>
                  <p style={{ textAlign: 'justify' }}>
                    Tùy vào từng trường hợp và thời gian chậm nộp báo cáo tài chính của doanh nghiệp mà mức phạt sẽ khác
                    nhau. Cụ thể: 5.000.000đ - 10.000.000đ nếu chậm nộp dưới 3 tháng; 10.000.000đ - 20.000.000đ nếu chậm
                    nộp từ 3 tháng trở lên. Chi tiết các trường hợp và mức phạt chậm nộp báo cáo tài chính bạn xem tại
                    link dưới đây.
                  </p>
                  <p style={{ textAlign: 'justify' }}>
                    <em aria-hidden='true' />
                    ...
                    <a href='http://localhost:3000/bao-cao-tai-chinh#buoc3'>
                      Thời hạn nộp báo cáo tài chính và quy định xử phạt nộp chậm
                    </a>
                    .
                  </p>
                </blockquote>
                ...
                <p style={{ textAlign: 'justify' }}>
                  <span className='mr-2 font-bold text-[20px] text-[#e5451b]'>+</span>
                  <strong>5. Lý do doanh nghiệp nên thuê dịch vụ báo cáo tài chính là gì?</strong>
                </p>
                <blockquote className='pl-3 mt-3 border-[#e5451b] border-l-[2px] '>
                  <p style={{ textAlign: 'justify' }}>
            ...
            <div className='row g-3'>
                ...
                <div className='border-bottom border-lg shadow-lg-sm shadow-0 rounded py-2 py-lg-0 h-100'>
                  <div className='row align-items-center'>
                    <div className='col-5 col-lg-12'>
                      <a href='/cach-tinh-tien-phat-cham-nop-thue.html' className='text-reset'>
                        <img data-src='/uploads/images/dich-vu-ke-toan.png' className='img-fluid lazy' />
                      </a>
                    </div>
              ...
              <div className='col-12 col-xl-3'>
                <div className='border-bottom border-lg shadow-lg-sm shadow-0 rounded py-2 py-lg-0 h-100'>
                  <div className='row align-items-center'>
                    <div className='col-5 col-lg-12'>
                      <a href='/chi-phi-ke-toan-va-chi-phi-thue-thu-nhap-doanh-nghiep.html' className='text-reset'>
                        <img data-src='/uploads/images/dich-vu-ke-toan.png' className='img-fluid lazy' />
                      </a>
                    </div>
                    <div className='col-7 col-lg-12'>
              ...
              <div className='col-12 col-xl-3'>
                <div className='border-bottom border-lg shadow-lg-sm shadow-0 rounded py-2 py-lg-0 h-100'>
                  <div className='row align-items-center'>
                    <div className='col-5 col-lg-12'>
                      <a href='/dang-ky-gia-han-va-huong-dan-su-dung-chu-ky-so.html' className='text-reset'>
                        <img
                    ...
                    <div className='col-7 col-lg-12'>
                      ...
                      >
                        <p className='fw-bold mb-0 text-justify text-lg-start p-lg-2 p-0'>
                          Thủ tục đăng ký, gia hạn &amp; hướng dẫn cách sử dụng chữ ký số
                        </p>
                      </a>
                    </div>
                  </div>
              ...
              <div className='col-12 col-xl-3'>
                <div className='border-bottom border-lg shadow-lg-sm shadow-0 rounded py-2 py-lg-0 h-100'>
                  <div className='row align-items-center'>
                    <div className='col-5 col-lg-12'>
                      <a href='/dich-vu-hoan-thue-gtgt.html' className='text-reset'>
                        <img
        ...
        <div className=' h-max top-0  p-lg-4 p-5 pt-lg-2 pb-lg-1 bg-light'>
          <div id='tham-khao-them' className='pb-4 text-justify'>
            ...
            <div className='my-3 pb-2 text-[#2a4e9a] border-b  border-bottom border-1'>
              <a className='text-primary  ' href='/thoi-han-nop-cac-loai-bao-cao-va-to-khai-thue-trong-nam.html'>
                Thời hạn nộp tờ khai thuế, báo cáo thuế theo quý &amp; theo tháng
              </a>
            </div>
            <div className='my-3 pb-2 text-[#2a4e9a] border-b  border-bottom border-1'>
              <a className='text-primary  ' href='/huong-dan-cach-dang-ky-va-nop-thue-dien-tu.html'>
                Hướng Dẫn Cách Đăng Ký Và Nộp Thuế Điện Tử
              </a>
            </div>
            <div className='my-3 pb-2 text-[#2a4e9a] border-b  border-bottom border-1'>
              <a className='text-primary  ' href='/thu-tuc-ke-khai-bao-cao-thue.html'>
                Thủ tục kê khai thuế các vi phạm &amp; mức phạt về BÁO CÁO THUẾ
              </a>
            </div>
            <div className='my-3 pb-2 text-[#2a4e9a] border-b  border-bottom border-1'>
              <a className='text-primary  ' href='/nop-to-khai-thue-qua-mang-dien-tu.html'>
          ...
          <div id='cung-chuyen-muc' className='pb-4 text-justify'>
            ...
            <div className='clearfix border-bottom border-1 mb-4'>
              <a className='flex text-reset fs-xxxl-5 fs-6' href='/thu-tuc-khai-thue-khi-thue-tai-san-cua-ca-nhan.html'>
                <img
            ...
            <div className='clearfix border-bottom border-1 mb-4'>
              <a className='flex text-reset fs-xxxl-5 fs-6' href='/cac-khoan-giam-tru-doanh-thu.html'>
                <img
                  data-src='/uploads/images/dich-vu-ke-toan.png'
                  className='w-[40%] col-5 img-fluid float-start pe-4 pb-4 lazy'
                  src={DichVuKeToanThueTronGoi}
            ...
            <div className='clearfix border-bottom border-1 mb-4'>
              <a className='flex text-reset fs-xxxl-5 fs-6' href='/dich-vu-hoan-thue-tncn.html'>
                <img
