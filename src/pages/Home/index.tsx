          ...
          <div className='w-max flex gap-x-3 lg:flex-col lg:gap-y-3 lg:w-full lg:h-full'>
            ...
            <div className='flex gap-x-3 lg:grid lg:grid-cols-2'>
              ...
              <div className='relative w-[370px] lg:w-full lg:h-full h-[208px] lg:col-span-1'>
                ...
                <div className='absolute bottom-0 h-full w-full bg-gradient-to-b from-transparent to-[rgba(0,0,0,0.4)]'></div>
                <p className='absolute bottom-4 left-4 font-medium text-white text-[17px]'>
                  Dịch vụ thành lập công ty có vốn đầu tư Nước Ngoài - Chỉ 15.000.000đ
                </p>
              </div>
            </div>
          </div>
      ...
      <div className='lg:col-span-2'>
        <Section title='Chia sẻ kinh nghiệm'>
          <div className='md:grid md:grid-cols-2 md:gap-x-6'>
            ...
            <div>
              <ItemSmall img={CachDatTen} title='Cách đặt tên công ty/doanh nghiệp - Hay Và Đúng (Có ví dụ)' />
              <ItemSmall img={ThueLaGi} title='Thuế môn bài là gì? Các bậc thuế & hạn nộp thuế môn bài 2023' />
              <ItemSmall img={VonDieuLe} title='Vốn điều lệ là gì? Có cần phải chứng minh vốn khi thành lập công ty' />
              <ItemSmall img={CongTy} title='Nên thành lập công ty trách nhiệm hữu hạn (TNHH) hay công ty cổ phần' />
            </div>
          </div>
        </Section>
        <Section title='Hồ sơ - thủ tục'>
          <div>
            ...
            <div className='md:grid md:grid-cols-2 md:gap-x-6'>
              <ItemSmall img={TraCuuMa} title='Tra cứu thông tin mã ngành nghề kinh doanh Việt Nam' />
              <ItemSmall img={ThueLaGis} title='Thuế là gì? Các khoản thuế phải nộp sau khi thành lập công ty' />
              <ItemSmall
                img={CacLoaiThue}
                title='Các loại thuế và cách tính thuế cho Hộ Kinh Doanh Cá Thể - Mới Nhất'
              />
              <ItemSmall img={ThuTucDangKy} title='Thủ tục đăng ký hộ kinh doanh cá thể và những lưu ý phải biết' />
            </div>
          </div>
        </Section>
      </div>
      <div className='lg:col-span-1'>
        ...
        <Section title='Bài viết xem nhiều'>
          <div className='md:grid md:grid-cols-2 gap-6 lg:flex lg:flex-col lg:gap-y-0'>
            <ViewestItem title='Dịch vụ thành lập công ty, doanh nghiệp Giá Rẻ -【 250.000đ 】' img={ThanhLapCongTY} />
            <ViewestItem
      ...
      <div className='lg:col-span-3'>
        <Section title='Thay đổi GPKD'>
          <div className='grid grid-cols-2 gap-6 lg:grid-cols-3 pb-8'>
            <GpkdItem title='Dịch vụ Thay Đổi Tên Công Ty - Chỉ 500.000đ (Không Phát Sinh Phí)' img={ThayDoiTen} />
            <GpkdItem title='Dịch vụ thay đổi địa chỉ công ty - Chỉ 500.000đ (Không Phát Sinh)' img={ThayDiaDiem} />
            <GpkdItem title='Dịch Vụ Bổ Sung Ngành Nghề Kinh Doanh 2023 - PHÍ CHỈ 500.000đ' img={BoSung} />
            <GpkdItem title='Dịch vụ làm thủ tục tăng vốn điều lệ công ty, doanh nghiệp - 500.000đ' img={TangVon} />
            <GpkdItem title='Dịch vụ làm thủ tục tăng giảm cổ đông công ty - Trọn gói 500.000đ' img={TangDong} />
            <GpkdItem title='Dịch Vụ Đổi Đại Diện Pháp Luật (giám đốc) Công Ty - Phí 500.000đ' img={DoiDaiDien} />
          </div>
        </Section>
      </div>
    </div>
