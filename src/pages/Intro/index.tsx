    ...
    <div>
      ...
      <div className='flex flex-col md:px-0 lg:px-0'>
        <p className='text-justify italic mb-4'>
          “Trong xu thế nền kinh tế ngày càng hội nhập và phát triển, nhu cầu đầu tư vào tất cả các lĩnh vực kinh doanh
          ngày càng cao, nhiều công ty gặp khó khăn trong vấn đề pháp lý và kế toán khi vận hành. Liệu rằng các doanh
          nghiệp có cân nhắc lựa chọn sử dụng dịch vụ pháp lý và kế toán, ngay từ những ngày đầu và sau đó?”
        </p>
        <p className='text-justify italic mb-4'>
          “Đối với doanh nghiệp nước ngoài việc thành lập công ty tại Việt Nam nên chuẩn bị hồ sơ, thủ tục và các bước
          thực hiện như thế nào là hợp pháp và tiết kiệm?”
        </p>
        <p className='text-justify italic mb-4'>
          “Vì sao các doanh nghiệp không lựa chọn giải pháp tối ưu hơn về các vấn đề liên quan đến lĩnh vực Kế toán và
          Pháp lý?”
        </p>
        <p className='text-justify italic mb-4'>
          “Các doanh nghiệp đã lựa chọn được đơn vị đồng hành cùng họ trong các giai đoạn hoạt động phù hợp?”
        </p>
