...
const allReviews = [
  ...
  },
  {
    ...
    rating: 5,
    content: "3 năm đồng hành cùng Anpha chưa bao giờ phải phàn nàn, công ty từ 3 nhân viên giờ giấn trăm nhân viên, thuậ sức thuê kế toán riêng, riêng mảng thuế vẫn tin tưởng giao phó hoàn toàn cho Anpha. cảm ơn các bạn, nhất là bạn Hương kế toán trưởng và bạn Xuân kế toán phụ trách công ty mình.",
    usefulCount: 1
},
{
    ...
    rating: 5,
    content: "Anpha đồng hành cùng công ty Kỳ Sóng Rồng Việt từ những ngày bắt đầu 2008. 10 năm qua vẫn luôn đặt niềm tin vào các bạn, sự tư vấn kịp thời, chính xác của các bạn góp phần không nhỏ góng sự thành công của Rồng Việt ngày hôm nay. Sẽ tiếp tục tin tưởng các dịch vụ của các bạn, cảm ơn rất nhiều.",
    usefulCount: 1
}
];
  ...
  return (
    <div className="rounded-lg p-6 border border-[#e5451b]">
      ...
      <div className="flex justify-between mt-4">
        <button onClick={loadPreviousReviews} disabled={currentIndex === 0} className="text-blue-500 hover:underline">
          Quay lại
        </button>
        <button
    ...
    <div>
      ...
      <div className="flex flex-col md:px-0 lg:px-0">
        ...
        <p className="text-justify mb-4">
          ...
          định thành lập công ty Kế toán Anpha, với mong muốn tạo ra công cụ phù
        ...
        <p className="text-justify mb-4">
          Đó là năm 2007 với trụ sở đầu tiên là 202 Lê Lai, Phường Bến Thành,
          Quận 1, TP. HCM.
        </p>
        ...
        <p className="text-justify mb-4">
          ...
          Anpha đã có mặt tại 5 tỉnh, thành phố của Việt Nam. Mỗi năm, chúng tôi
        ...
        <p className="text-justify mb-4">
          ...
          ngoài nước, Anpha luôn cố gắng mang lại cho khách hàng trải nghiệm An
        ...
        <p className="text-justify">
          Tại Anpha, hoàn thành nhiệm vụ và mang đến cho khách hàng trải nghiệm
      ...
      <div className="my-4">
        ...
        <div className="grid gap-3 grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
          {posts.map((post, index) => (
            <div
              key={index}
              className="border-b lg:border lg:shadow-lg shadow-none rounded py-2 lg:py-0 h-full"
            >
              <div className="flex flex-col  align-middle">
                ...
                <div className="w-full lg:w-auto">
                  <a
                    href={post.link}
                    className="text-reset overflow-hidden line-clamp-3"
                  >
                    <p className="font-bold mb-0 text-justify lg:text-left p-2 p-lg-0">
                      {post.text}
                    </p>
                  </a>
                </div>
