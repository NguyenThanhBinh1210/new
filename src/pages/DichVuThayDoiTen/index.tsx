        ...
        <div className='row g-2 g-lg-5'>
          <div id='ContentBody_fullpage' className='col-lg-8'>
            ...
            <div id='ContentBody_post_body' className='news-body mb-4 text-justify'>
                ...
                <ul className='noi-dung-chinh ml-4 mb-4 mt-3'>
                  ...
                  <li>
                    <a href='#Thoi-gian-hoan-thanh-thu-tuc-thay-doi-ten-cong-ty,-doanh-nghiep'>
                      Thời gian hoàn thành thủ tục thay đổi tên công ty, doanh nghiệp
                    </a>
                  </li>
                  <li>
                  ...
                  <li>
                    <a href='#4-luu-y-sau-khi-thay-doi-ten-doanh-nghiep'>4 lưu ý sau khi thay đổi tên doanh nghiệp</a>
                  </li>
                  <li>
              ...
              <h3 className='sub-title' id='Tong-chi-phi-thay-doi-ten-cong-ty,-doanh-nghiep'>
                <a id='buoc1'>Tổng chi phí thay đổi tên công ty, doanh nghiệp</a>
              </h3>
              <p style={{ textAlign: 'justify' }}>
                Để thay đổi tên công ty cổ phần, thay đổi tên công ty TNHH hay bất cứ loại hình doanh nghiệp nào, bạn
                cần chuẩn bị các khoản phí sau:
              </p>
              <p>
                <strong>
                  <img
              ...
              <ul>
                <li>
                  <p style={{ textAlign: 'justify' }}>
                    200.000 đồng lệ phí nộp hồ sơ và cấp GPKD mới tại Sở KH&amp;ĐT;
                  </p>
                </li>
                <li>
                  <p style={{ textAlign: 'justify' }}>400.000 đồng lệ phí khắc dấu và công bố mẫu dấu mới;</p>
                </li>
                <li>
                  <p style={{ textAlign: 'justify' }}>
              ...
              <h3 className='sub-title' id='Thoi-gian-hoan-thanh-thu-tuc-thay-doi-ten-cong-ty,-doanh-nghiep'>
                <a id='buoc2'>Thời gian hoàn thành thủ tục thay đổi tên công ty, doanh nghiệp</a>
              </h3>
              <p>
                <strong>
                  <img
              ...
              <CallNow></CallNow>
              <p style={{ textAlign: 'justify' }}>&nbsp;</p>
              <h3 className='sub-title' id='2-thong-tin-doanh-nghiep-can-cung-cap'>
              ...
              <ol>
                ...
                <li>
                  <p style={{ textAlign: 'justify' }}>Trình khách hàng ký hồ sơ tận nơi;</p>
                </li>
                <li>
                  <p style={{ textAlign: 'justify' }}>Nộp hồ sơ thay đổi tên công ty tại Sở KH&amp;ĐT;</p>
                </li>
                <li>
                  <p style={{ textAlign: 'justify' }}>
                ...
                <li>
                  <p style={{ textAlign: 'justify' }}>Bàn giao GPKD mới và con dấu (nếu có) tận nơi.</p>
                </li>
              </ol>
              <p style={{ textAlign: 'justify' }}>
                <u>Lưu ý:</u>&nbsp;
              ...
              <p style={{ textAlign: 'justify' }}>
                Sau khi hoàn thành thủ tục đổi tên công ty, để tránh bị xử phạt các lỗi pháp lý, bạn cần lưu ý thực hiện
                những vấn đề sau:
              </p>
              <ol>
                <li>
                  <p style={{ textAlign: 'justify' }}>Khắc dấu và công bố mẫu dấu mới - 400.000 đồng;</p>
                </li>
                <li>
                  <p style={{ textAlign: 'justify' }}>Làm bảng hiệu mới - 200.000 đồng/bảng hiệu;</p>
                </li>
                <li>
                  <p style={{ textAlign: 'justify' }}>Trả con dấu cũ cho cơ quan công an;</p>
                </li>
                <li>
                  <p style={{ textAlign: 'justify' }}>
              ...
              <h3 className='sub-title' id='Cac-cau-hoi-thuong-gap-khi-thay-doi-ten-cong-ty'>
                <a id='buoc6'>Các câu hỏi thường gặp khi thay đổi tên công ty</a>
              </h3>
              <div id='faq'>
                <p style={{ textAlign: 'justify' }}>
                ...
                <blockquote className='pl-3 mt-3 border-[#e5451b] border-l-[2px]'>
                  <p style={{ textAlign: 'justify' }}>
                    Sau khi hoàn tất thủ tục thay đổi tên công ty, bạn lưu ý thực hiện các việc sau: làm bảng hiệu với
                    tên công ty vừa thay đổi; trả con dấu cũ cho cơ quan công an; khắc và công bố mẫu dấu mới; thông báo
                    phát hành hóa đơn theo tên công ty mới.
                  </p>
                  <p style={{ textAlign: 'justify' }}>
                    &nbsp;
                    <em aria-hidden='true' className='fa-angle-double-right fas' style={{ color: '#e5451b' }} />
                ...
                <p style={{ textAlign: 'justify' }}>
                  <span className='mr-2 font-bold text-[20px] text-[#e5451b]'>+</span>
                  <strong>3. Thủ tục đổi tên giấy phép kinh doanh gồm những gì?</strong>
                </p>
                <blockquote className='pl-3 mt-3 border-[#e5451b] border-l-[2px]'>
                  <p style={{ textAlign: 'justify' }}>
                ...
                <p style={{ textAlign: 'justify' }}>
                  <span className='mr-2 font-bold text-[20px] text-[#e5451b]'>+</span>
                  <strong>5. Thủ tục đổi tên doanh nghiệp thực hiện trong mấy ngày?</strong>
                </p>
                <blockquote className='pl-3 mt-3 border-[#e5451b] border-l-[2px]'>
                  <p style={{ textAlign: 'justify' }}>
                    ...
                    &nbsp;để hồ sơ xin đổi tên doanh nghiệp được hoàn thành nhanh chóng.
                  </p>
                </blockquote>
                <hr />
                <p style={{ textAlign: 'justify' }}>
                  <span className='mr-2 font-bold text-[20px] text-[#e5451b]'>+</span>
                  <strong>6. Cách xử lý hóa đơn sau khi thay đổi tên công ty?</strong>
                </p>
                <blockquote className='pl-3 mt-3 border-[#e5451b] border-l-[2px]'>
                  <p style={{ textAlign: 'justify' }}>
                    Tùy vào loại hóa đơn doanh nghiệp sử dụng mà cách xử lý hóa đơn khi thay đổi tên công ty sẽ khác
                    nhau.
                  </p>
                  <p style={{ textAlign: 'justify' }}>
                    <em aria-hidden='true' />
            ...
            <div className='row g-3'>
                ...
                <div className='border-bottom border-lg shadow-lg-sm shadow-0 rounded py-2 py-lg-0 h-100'>
                  <div className='row align-items-center'>
                    <div className='col-5 col-lg-12'>
                      <a href='/ho-so-thay-doi-ten-cong-ty.html' className='text-reset'>
                        <img data-src='/uploads/images/ho-so-thay-doi-ten-cong-ty.jpg' className='img-fluid lazy' />
                      </a>
                    </div>
                    <div className='col-7 col-lg-12'>
                      ...
                      >
                        <p className='fw-bold mb-0 text-justify text-lg-start p-lg-2 p-0'>
                          Hồ sơ, thủ tục thay đổi tên công ty, doanh nghiệp - Có file mẫu
                        </p>
                      </a>
                    </div>
                  </div>
              ...
              <div className='col-12 col-xl-3'>
                <div className='border-bottom border-lg shadow-lg-sm shadow-0 rounded py-2 py-lg-0 h-100'>
                  <div className='row align-items-center'>
                    <div className='col-5 col-lg-12'>
                      <a href='/cach-dat-ten-cong-ty.html' className='text-reset'>
                        <img data-src='/uploads/images/cach-dat-ten-cong-ty(2).png' className='img-fluid lazy' />
                      </a>
                    </div>
                    <div className='col-7 col-lg-12'>
                      <a
              ...
              <div className='col-12 col-xl-3'>
                <div className='border-bottom border-lg shadow-lg-sm shadow-0 rounded py-2 py-lg-0 h-100'>
                  <div className='row align-items-center'>
                    <div className='col-5 col-lg-12'>
                      <a href='/thay-doi-giay-phep-kinh-doanh.html' className='text-reset'>
                        <img data-src='/uploads/images/thay-doi-giay-phep-kinh-doanh.jpg' className='img-fluid lazy' />
                      </a>
                    </div>
                    <div className='col-7 col-lg-12'>
                      <a
                      ...
                      >
                        <p className='fw-bold mb-0 text-justify text-lg-start p-lg-2 p-0'>
                          Dịch vụ thay đổi Giấy Phép Đăng Ký Kinh Doanh, chỉ 500.000đ
                        </p>
                      </a>
                    </div>
                  </div>
                  ...
                  <div className='row align-items-center'>
                    <div className='col-5 col-lg-12'>
                      <a href='/doi-tru-so-cong-ty.html' className='text-reset'>
                        <img data-src='/uploads/images/doi-tru-so-cong-ty.jpg' className='img-fluid lazy' />
                      </a>
                    </div>
                    <div className='col-7 col-lg-12'>
                      <a
                      ...
                      >
                        <p className='fw-bold mb-0 text-justify text-lg-start p-lg-2 p-0'>
                          Dịch vụ làm thủ tục thay đổi địa chỉ trụ sở công ty, chỉ 500.000đ
                        </p>
                      </a>
                    </div>
                  </div>
            ...
            <div className='tagclouds mt-3 text-justify'>
              ...
              <a rel='nofollow' className='text-muted bg-light px-2 ms-1 text-capitalize' href='/doi-ten-cong-ty'>
                <small>đổi tên công ty</small>
              </a>
              <a rel='nofollow' className='text-muted bg-light px-2 ms-1 text-capitalize' href='/doi-ten-doanh-nghiep'>
                <small>đổi tên doanh nghiệp</small>
              </a>
              <a rel='nofollow' className='text-muted bg-light px-2 ms-1 text-capitalize' href='/thay-doi-ten-cong-ty'>
