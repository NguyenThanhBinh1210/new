import Img from '~/assets/images/soát xét 2.png'
const index = () => {
  return (
          ...
          <div className='row'>
            <div className='col-md-12 col-sm-12 col-xs-12'>
              <div className='main-page'>
                <h2 className='page-title text-[22px] uppercase font-semibold mb-4'>BÁO CÁO TÀI CHÍNH </h2>
                <div className='page-content clearfix'>
                  <article className='entry-detail'>
                    <div className='entry-photo w-[90%] mx-auto border rounded-sm p-2'>
                      <img src={Img} className='' />
                    </div>{' '}
                    <div className='entry-content clearfix'>
                      <p style={{ textAlign: 'justify' }}>
                        <span style={{ fontFamily: 'helvetica, arial, sans-serif' }}>
                          Dịch vụ làm báo cáo tài chính uy tín, chuyên nghiệp, làm việc hiệu quả, hỗ trợ tối đa. Doanh
                          nghiệp không cần phải lo lắng tới việc làm báo cáo tài chính trong dịp cuối năm nữa.
                        </span>
                      </p>
                      <p style={{ textAlign: 'justify' }}>
                        <span style={{ fontFamily: 'helvetica, arial, sans-serif' }}>
                        ...
                        <br />
                        <span style={{ fontFamily: 'helvetica, arial, sans-serif' }}>– Kiểm tra chứng từ kế toán;</span>
                        <br />
                        <span style={{ fontFamily: 'helvetica, arial, sans-serif' }}>
                      ...
                      <p style={{ textAlign: 'justify' }}>
                        <span style={{ fontFamily: 'helvetica, arial, sans-serif' }}>
                          <strong>II – KẾT QUẢ CÔNG VIỆC</strong>
                        </span>
                        <br />
                        <span style={{ fontFamily: 'helvetica, arial, sans-serif' }}>
                        ...
                        <br />
                        <span style={{ fontFamily: 'helvetica, arial, sans-serif' }}>
                          – Bộ báo cáo tài chính (Gồm: Bảng cân đối tài khoản; bảng cân đối kế toán; báo cáo kết quả
                        ...
                        <br />
                        <span style={{ fontFamily: 'helvetica, arial, sans-serif' }}>– Sổ nhật ký chung</span>
                        <br />
                        <span style={{ fontFamily: 'helvetica, arial, sans-serif' }}>– Sổ cái các tài khoản</span>
                        <br />
                        <span style={{ fontFamily: 'helvetica, arial, sans-serif' }}>– Sổ quỹ tiền mặt</span>
                        <br />
                        <span style={{ fontFamily: 'helvetica, arial, sans-serif' }}>– Sổ tiền gửi ngân hàng</span>
                        <br />
                        <span style={{ fontFamily: 'helvetica, arial, sans-serif' }}>
