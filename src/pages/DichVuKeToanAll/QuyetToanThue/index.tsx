import Img from '~/assets/images/soát xét 1.png'
          ...
          <div className='row'>
            <div className='col-md-12 col-sm-12 col-xs-12'>
              <div className='main-page'>
                <h2 className='page-title text-[22px] uppercase font-semibold mb-3'>QUYẾT TOÁN THUẾ </h2>
                    ...
                    <div className='entry-content clearfix'>
                      <div style={{ textAlign: 'justify' }}>
                        <span style={{ fontFamily: 'helvetica, arial, sans-serif' }}>
                          <em>
                            <strong>1. Công việc khi thực hiện dịch vụ quyết toán thuế</strong>
                          </em>
                        </span>
                        <br />
                        <span style={{ fontFamily: 'helvetica, arial, sans-serif' }}>
                        ...
                        <br />
                        <span style={{ fontFamily: 'helvetica, arial, sans-serif' }}>
                          – Lập sổ sách kế toán, báo cáo tài chính, báo cáo kết quả kinh doanh, thuyết minh báo cáo tài
                          chính;
                        </span>
                        <br />
                        <span style={{ fontFamily: 'helvetica, arial, sans-serif' }}>
                        ...
                        <br />
                        <span style={{ fontFamily: 'helvetica, arial, sans-serif' }}>
                          – Tư vấn cho doanh nghiệp các nội dung có liên quan trong quá trình tổng hợp thông tin để lập
                      ...
                      <div style={{ textAlign: 'justify' }}>
                        <span style={{ fontFamily: 'helvetica, arial, sans-serif' }}>
                          <em>
                            <strong>2. Công viêc của khách hàng khi thực hiện dịch vụ quyết toán thuế</strong>
                          </em>
                        </span>
                        <br />
                        <span style={{ fontFamily: 'helvetica, arial, sans-serif' }}>
                          – Cung cấp thông tin : Các hóa đơn đầu vào, hóa đơn đầu ra; chứng từ thanh toán qua ngân hàng;
                          bảng lương nhân viên; hợp đồng; công nợ; các báo cáo thuế ….
                        </span>
                        <br />
                        <span style={{ fontFamily: 'helvetica, arial, sans-serif' }}>
