      ...
      <div className='p-5'>
        ...
        <div className='bg-white p-4 rounded-md shadow-lg'>
          ...
          <div className='flex justify-between'>
            ...
            <button onClick={() => setIsVisible(!isVisible)} className='bg-blue-500 text-white p-2 rounded'>
              GỬI NHANH
            </button>
          </div>
        </div>
      ...
      {isVisible && (
        <div className='fixed top-0  w-full left-0'>
          ...
          <div className='bg-white p-6 rounded shadow-lg w-96 z-100 w-full left-[50%] top-[50%] translate-y-[-50%] translate-x-[-50%] max-w-md max-h-full absolute '>
            <div className='text-lg font-bold mb-4'>GẦN XONG! HÃY GIÚP CHÚNG TÔI TRẢ LỜI BẠN.</div>
            <div className='mb-4'>
              <label className='block text-sm font-medium mb-1'>Số điện thoại (để nhận phản hồi qua điện thoại)</label>
              <input
                type='text'
                value={phoneNumber}
            ...
            <div className='mb-4'>
              <label className='block text-sm font-medium mb-1'>Email (để nhận phản hồi qua email)</label>
              <input
                type='email'
                value={email}
            ...
            <button onClick={handleSubmit} className='w-full bg-red-500 text-white py-2 rounded'>
